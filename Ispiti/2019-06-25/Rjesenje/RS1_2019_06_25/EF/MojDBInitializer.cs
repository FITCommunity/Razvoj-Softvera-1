...
namespace RS1_2019_06_25.EF
{
    public class MojDBInitializer
    {
        public static void Izvrsi(MojContext context)
        {
            ...
            var AkademskaGodina1 = new AkademskaGodina { Opis = "2018/19" };
            var AkademskaGodina2 = new AkademskaGodina { Opis = "2019/20" };
            ...
            foreach (Angazovan a in Angazovan)
            {
                for (int i = 0; i < 30; i++)
                {
                    var o = new OdrzaniCas
                    {
                        Angazovani = a,
                        Datum = DateTime.Now.AddDays(-i*7)
                    };
                    context.Add(o);
                }
            }
